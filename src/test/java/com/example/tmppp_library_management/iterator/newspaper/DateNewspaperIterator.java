...
public class DateNewspaperIterator implements NewspaperIterator {
    private List<Newspaper> newspapers;
    private int position;

    public DateNewspaperIterator(List<Newspaper> newspapers) {
        this.newspapers = new ArrayList<>(newspapers);
        this.newspapers.sort(Comparator.comparing(Newspaper::getPublicationDate));
        this.position = 0;
    }
